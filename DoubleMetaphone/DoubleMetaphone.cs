    ...
    public class DoubleMetaphoneUDT
    {
        [SqlFunction(DataAccess = DataAccessKind.None, IsDeterministic =true,IsPrecise =true)]
        public static string DoubleMetaphoneExec(string value)
        {
            string pk = null;
            string ak = null;
            DoubleMetaphone.doubleMetaphone(value, ref pk, ref ak);
        ...
        /// 										</summary>
        private class DoubleMetaphone
        {
            public const int METAPHONE_KEY_LENGTH = 8;//The length of the metaphone keys produced.  4 is sweet spot
